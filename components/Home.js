        ...
        <Footer>
          <FooterTab>
            <Button active badge vertical>
              <Badge style={{backgroundColor: "#707070"}}><Text>2</Text></Badge>
            ...
            <Button badge vertical>
              <Badge style={{backgroundColor: "#707070"}}><Text>51</Text></Badge>
              <Icon active name="user" type="FontAwesome" style={styles.icon}/>
              <Text>Profile</Text>
            </Button>
            <Button vertical>
